<template>
  <div class="card" v-for="item in chosen" :key="item" style="width: 18rem">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary" @click="addtocart(item.id)"
        >Add to cart</a
      >
    </div>
  </div>
  ...
  <div class="filterdropdowns">
    ...
    <select @change="handleChange" name="Category" id="Category">
      ...
      <option value="2">casual</option></select
    ><br /><br /><br />
    <h3>Gender</h3>
    ...
    <select @change="handleChange2" name="PriceRange" id="PriceRange">
      ...
      <option value="2">more than 50</option></select
    ><br /><br /><br />
    <h3>size</h3>
    <select @change="handleChange3" name="Sizing" id="Sizing">
      <option value="1">S</option>
      <option value="2">M</option>
      <option value="3">L</option></select
    ><br /><br /><br />
